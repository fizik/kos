...
static const EndpointInfo endpointsInfo_mosquitto_Changestate_7[2] = {
    {
        .name = "mosquitto.Setcommand.setcommand",
        .riid = 0,
        .iface_name = "mosquitto.Setcommand",
    },
    {
        .name = "Changestate.setcommand",
        .riid = 0,
        .iface_name = "mosquitto.Setcommand",
    }
};
static const EntityInfo taskInfo_mosquitto_Changestate_7 = {
    .eiid = "mosquitto.Changestate",
    .max_endpoints = 2,
    .endpoints = endpointsInfo_mosquitto_Changestate_7,
};
static const EndpointInfo endpointsInfo_mosquitto_Showapp_8[2] = {
    {
...
static const EntityInfo taskInfo_mosquitto_Showapp_8 = {
    .eiid = "mosquitto.Showapp",
    .max_endpoints = 2,
    .endpoints = endpointsInfo_mosquitto_Showapp_8,
};
static const EntityInfo taskInfo_mosquitto_Subscriber_9 = {
...
int main(void) {
    ...
    Entity * task_mosquitto_Changestate_7;
    Entity * task_mosquitto_Showapp_8;
    Entity * task_mosquitto_Subscriber_9;
    ...
    const char * taskInfo_mosquitto_Subscriber_9_env[] = {
    ...
    const char * taskInfo_mosquitto_Changestate_7_args[] = {
        "Changestate",
        RTL_NULL
    };
    const char * taskInfo_mosquitto_Showapp_8_args[] = {
        "Showapp",
        RTL_NULL
    };
    const char * taskInfo_mosquitto_Subscriber_9_args[] = {
        "Subscriber",
        RTL_NULL
    };
    ...
    task_mosquitto_Changestate_7 = EntityInitEx(
        &taskInfo_mosquitto_Changestate_7, "mosquitto.Changestate", "Changestate"
    );
    if (!task_mosquitto_Changestate_7) {
        fprintf(
            stderr, "Can't initialize task \"mosquitto.Changestate\"\n"
        );
        return EXIT_FAILURE;
    }

    if (EntitySetArgs(task_mosquitto_Changestate_7, taskInfo_mosquitto_Changestate_7_args) != rcOk) {
        fprintf(
            stderr, "Can't set args for task \"mosquitto.Changestate\"\n"
        );
        return EXIT_FAILURE;
    }
    task_mosquitto_Showapp_8 = EntityInitEx(
        &taskInfo_mosquitto_Showapp_8, "mosquitto.Showapp", "Showapp"
    );
    if (!task_mosquitto_Showapp_8) {
        fprintf(
    ...
    if (EntitySetArgs(task_mosquitto_Showapp_8, taskInfo_mosquitto_Showapp_8_args) != rcOk) {
        fprintf(
    ...
    task_mosquitto_Subscriber_9 = EntityInitEx(
        &taskInfo_mosquitto_Subscriber_9, "mosquitto.Subscriber", "Subscriber"
    );
    if (!task_mosquitto_Subscriber_9) {
        fprintf(
            stderr, "Can't initialize task \"mosquitto.Subscriber\"\n"
        );
        return EXIT_FAILURE;
    }
    if (EntitySetEnv(task_mosquitto_Subscriber_9, taskInfo_mosquitto_Subscriber_9_env) != rcOk) {
        fprintf(
            stderr, "Can't set env for task \"mosquitto.Subscriber\"\n"
        );
        return EXIT_FAILURE;
    }
    if (EntitySetArgs(task_mosquitto_Subscriber_9, taskInfo_mosquitto_Subscriber_9_args) != rcOk) {
        fprintf(
    ...
    if (EntityConnectToService(task_mosquitto_Showapp_8, task_mosquitto_Changestate_7, "changestate_connection") != rcOk) {
        fprintf(stderr, "Can't setup a connection %s\n", "changestate_connection");
        return EXIT_FAILURE;
    }
    ...
    if (EntityConnectToService(task_mosquitto_Subscriber_9, task_kl_VfsNet_1, "kl.VfsNet") != rcOk) {
        fprintf(stderr, "Can't setup a connection %s\n", "kl.VfsNet");
        return EXIT_FAILURE;
    }
    if (EntityConnectToService(task_mosquitto_Subscriber_9, task_kl_VfsRamFs_2, "kl.VfsRamFs") != rcOk) {
        fprintf(stderr, "Can't setup a connection %s\n", "kl.VfsRamFs");
        return EXIT_FAILURE;
    }
    if (EntityConnectToService(task_mosquitto_Subscriber_9, task_mosquitto_Showapp_8, "showapp_connection") != rcOk) {
        fprintf(stderr, "Can't setup a connection %s\n", "showapp_connection");
        return EXIT_FAILURE;
    }
    ...
    if (EntityRun(task_mosquitto_Changestate_7) != rcOk) {
        fprintf(
            stderr, "Can't run task \"mosquitto.Changestate\"\n"
        );
        return EXIT_FAILURE;
    }
    if (EntityRun(task_mosquitto_Showapp_8) != rcOk) {
        fprintf(
    ...
    if (EntityRun(task_mosquitto_Subscriber_9) != rcOk) {
        fprintf(
